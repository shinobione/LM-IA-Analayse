...
assert.match(loader, /js\/semantic-bootstrap\.js\?v=7/);
assert.match(loader, /sonictraceLoader\s*=\s*'v3\.4\.0'/);

console.log('Semantic V3.4 bootstrap ordering + cache-bust regression: PASS');